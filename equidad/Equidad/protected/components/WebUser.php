...
class WebUser extends CWebUser
{
    ...
    public function init()
    {
        ...
        $this->itemsMenu=Yii::app()->db->createCommand()
                ...
                ->queryAll();
        $this->dataUsuario = Yii::app()->db->createCommand()
          ->select()    
          ->from('adm_usuario usu')
          ->join('tblareascorrespondencia are', 'usu.area=are.areasid')
          ->join('tblradofi age', 'age.codigo=are.agencia')
          ->where('usuario_cod=:usuario_cod', array(':usuario_cod'=>$this->id))
          ->queryRow();
    ...
    {
        return $this->dataUsuario['id_agencia'];
    }

    public function getDescUsuario()
    {
        return $this->dataUsuario['usuario_desc'];
    }

    public function getNombreCompleto()
    {
        return $this->dataUsuario['usuario_nombres'].' '.$this->dataUsuario['usuario_priape'].' '.$this->dataUsuario['usuario_segape'];
    }

    public function getArea()
    {
        return $this->dataUsuario['area'];
    }

    public function getAgencia()
    {
        return $this->dataUsuario['descrip'];
    }
