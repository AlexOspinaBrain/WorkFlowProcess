 ...
 */
class Tblareascorrespondencia extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Tblareascorrespondencia the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'proveedors' => array(self::HAS_MANY, 'Proveedor', 'areasid'),
