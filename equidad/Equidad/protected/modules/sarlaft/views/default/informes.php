...
<div class="row">
    ...
    <div class="span10">
    	...
    	<div class="well">
    	<br>
    	<legend>Informes SARLAFT</legend>
...
<?php echo $form->dropDownListRow($modelInformesForm,'informe',array('1'=>'Gestión & Tiempos','2'=>'Gestión & Tiempos Autos','3'=>'Radicados Agencia','4'=>'Cierre Diario Prioritario')); ?>

<?php echo $form->error($modelInformesForm, 'informe') ?>	
	
<?php echo $form->labelEx($modelInformesForm,'fechai'); ?>
<?php //echo $form->textFieldRow($modelInformesForm, 'fechai') ?>	
<?php //echo $form->error($modelInformesForm, 'fechai') ?>	
<?php
...
<?php //echo $form->textFieldRow($modelInformesForm, 'fechaf') ?>	
<?php //echo $form->error($modelInformesForm, 'fechaf') ?>	
<?php
...
<?php
if ($informeus && ($modelInformesForm->informe === '1' || $modelInformesForm->informe === '2')){
	        	...
	        	array(
			        ...
			        'buttons' => array(
			            'view' => array(
			                ...
			                //'url'=> '$data->usudesc',
			                'icon' => 'icon-eye-open',  
			                'url'=>'Yii::app()->createUrl("sarlaft/default/informeEntramitexls", 
...
}elseif ($informeus && $modelInformesForm->informe === '3'){
...
<?php
	$gridDataProvider = new CArrayDataProvider($informeus,
		array(
			'sort'=>array(
        		'attributes'=>array(
             		'nagencia', 'cantidad', 'agencia', 'ok', 'novi', 'anu', 'pend', 'comp', 'fechaiq', 'fechaiq'
        		),
    		),
			'pagination'=>array('pageSize'=>99999999)
		)
...
}elseif ($informeus && $modelInformesForm->informe === '4'){
                ...
                array(
                    ...
                    'buttons' => array(
                        array('label' => 'Exportar',               
                            ...
                            'items' => array(                                
                                array('label' => 'Excel', 'url' => '#', 'icon' => 'icon-download', 'linkOptions' =>array('onClick'=>'js:exportExcelG4()')),
                            )
                        )
                    )
                )
	...
	$inn = 'Atendidos en el dia';
	$outt = 'No Atendidos en el dia';

	$gridDataProvider = new CArrayDataProvider($informeus,
			array(
				'sort'=>array(
	        		'attributes'=>array(
	             		'nagencia', 'cantidad', 'usudesc', 'instd', 'outstd', 'fechaiq', 'fechaiq', 'infor'
	        		),
	    		),
				'pagination'=>array('pageSize'=>99999999)
			)
	...
	$this->widget(
	    ...
	    array(
	        ...
	        'columns' => array(
	        		...
	        		array(
			       			'header'=>'Radicados antes de las 4 pm.',    			
            				'name'=>'cantidad',
