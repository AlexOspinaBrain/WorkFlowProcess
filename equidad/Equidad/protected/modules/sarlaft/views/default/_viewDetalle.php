        ...
        <table class="detail-view table table-bordered table-striped table-condensed">
            <tbody>
                ...
                <tr class="even">
                            ...
                            <?php if($model->fecha_formulario!=null) { ?>
                                <th><?= $model->getAttributeLabel('fecha_formulario') . " (año-mes-dia)"?></th>
                                    <td colspan="2"><?= Yii::app()->dateFormatter->format("y-M-d",$model->fecha_formulario) ; ?></td>
                            <?php }?>
