...
<div class="row">
    ...
    <div class="span10">
        ...
        <?php if(Yii::app()->user->hasFlash('nootusu')):?>
        <div class="alert alert-warning">
            <?php echo Yii::app()->user->getFlash('nootusu'); ?>
        </div>

        <?php endif; ?>

        <?php if(Yii::app()->user->hasFlash('caok')):?>
        <div class="alert alert-success">
            <?php echo Yii::app()->user->getFlash('caok'); ?>
        </div>
    ...
    <div>
           ...
           <?php //echo CHtml::dropDownList('estadoq',array('empty' => ''),
           //SWHelper::allStatuslistData($model),
           //array('prompt' => 'Filtro excel','id'=>'estadoq')); ?>
...
<script type="text/javascript">	
    ...
    function exportExcel(){     
        ...
        if(cantidad > 5000){
            alert("Realice una consulta con menos de 5.000 tramites");
            return;
        }
        
        //location.href = '<?=$this->createUrl("default/consultaTramitesExcel")?>?'+ $("#gridConsultaTramites input").serialize()+'&estadoq='+$('#estadoq').val();
        location.href = '<?=$this->createUrl("default/consultaTramitesExcel")?>?'+ $("#gridConsultaTramites select,input").serialize();
    }
