...
/**
 * This is the model class for table "sar_ramo".
 *
 * The followings are the available columns in table 'sar_ramo':
...
class Ramo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ramo', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_ramo, ramo', 'safe', 'on'=>'search'),
		);
	}
