...
/**
 * This is the model class for table "idm_historial".
 *
 * The followings are the available columns in table 'idm_historial':
...
class Historial extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fecha_inicio, estado, id_radica, usuario_cod, observacion', 'required'),
