...
/**
 * This is the model class for table "idm_documento".
 *
 * The followings are the available columns in table 'idm_documento':
...
class Documento extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'idmClasifiDocs' => array(self::HAS_MANY, 'IdmClasifiDoc', 'id_documento'),
		);
	}
