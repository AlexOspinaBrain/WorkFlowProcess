...
class Usuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('usuario_cod, usuario_desc, usuario_contrasena, usuario_nombres, usuario_priape, usuario_segape, usuario_correo, usuario_numentradas, usuario_bloqueado, area, tipodoc, numerodoc, usuario_ultfecha', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'susHistorials' => array(self::HAS_MANY, 'SusHistorial', 'usuario_cod'),
