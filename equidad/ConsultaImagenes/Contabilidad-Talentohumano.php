	...
	<script type="text/javascript">
		...
		function tables(){
			$(".flexme3").flexigrid({
				...
				dataType : 'xml',
				params:		[ { name: 'consulta', value: 'TalentoHumano' }							  
							],
				colModel : [ { display : 'Nombre',	name : 'nombre', width : 450, sortable : true, align : 'left'}, 
							 ...
							 { display : 'Banco',	name : 'banco', width : 180, sortable : true,	align : 'left'}, 
		...
		function ExportExcel(){
			parametros="consulta="+"TalentoHumano";
...
<?=OpcionesSelect('Compania', 'planillastesoreria pla', 'distinct(compañia)', 'pla.compañia', 'where pla.cab=53')?>
</body>
</html>
<?php
