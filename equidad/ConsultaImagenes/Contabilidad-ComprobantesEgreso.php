	...
	<script type="text/javascript">
        $(document).ready(function() {	
			...
			$('#Borrar').click(function(){
				$('#Nombre, #Desde, #Hasta, #Compania, #Agencia, #Cheque, #Comprobante').val('');
				CambiaFiltros();
			});
			$('#Nombre, #Desde, #Hasta, #Compania, #Agencia, #Cheque, #Comprobante').keypress(function(e) {
				if(e.which == 13) 
					CambiaFiltros();				
			});
		...
		function tables(){
			$(".flexme3").flexigrid({
				...
				dataType : 'xml',
				params:		[ { name: 'consulta', value: 'ComprobantesEgreso' }							  
							],
				colModel : [ { display : 'Nombre / Razón social',	name : 'nombre', width : 350, sortable : true, align : 'left'}, 
							 ...
							 { display : 'Agencia',	name : 'agencia', width : 180, sortable : true,	align : 'left'}, 
							 { display : 'Cheque', name : 'cheque',	width : 220, sortable : true, align : 'left'}, 
							 { display : 'Comprobante', name : 'comprobante',	width : 220, sortable : true, align : 'left'}, 
		...
		function ExportExcel(){
			parametros="consulta="+"ComprobantesEgreso";
...
<table align='center'><tr><td>
	...
	<fieldset style="width:130px;height:50px;" class='filtros'>
		<legend><b>Cheque: </b></legend>			
		<input type="text" id="Cheque" style='width:120px'/>
	</fieldset>
