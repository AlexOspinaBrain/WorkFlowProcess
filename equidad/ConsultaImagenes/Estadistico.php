	...
	<script type="text/javascript">
		...
		function tables(){
			$("#Gridproductos").flexigrid({
				...
				colModel : [ 
							 { display: 'Proceso', name : 'informe', width : 270, sortable : true, align: 'left', }, 
							 { display: 'Cantidad', name : 'total', width : 80, sortable : true, align: 'center' }										 
						   ],
				sortname : "ord",
				sortorder : "asc",				
				title : 'Informe estadistico de imágenes',
				width : 400,
				height :  200,
				resizable:false,
				usepager : false,
...
<body>
	<table align='center'><tr><td>		
		<fieldset style="height:40px;" class='filtros'>
			...
			<input type="text" id="Hasta" style='width:70px' value="<?php echo date("Ymd")?>"/>	
